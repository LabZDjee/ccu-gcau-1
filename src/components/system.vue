              ...
              <div class="d-flex justify-center">
                <div class="half">
                  <vyw-select-input
                    data-key="Language"
                    label="Language"
                    :item-list="selectChoices.languages"
                    hint="local language"
                  />
                </div>
              </div>
          ...
          <v-card class="mt-1">
            ...
            <v-card-text>
              ...
              <div class="d-flex">
                <div class="pr-1">
                  <vyw-select-input
                    data-key="Combo_RN_UDC"
                    label="DC voltage"
                    :item-list="dcVoltages"
                    hint="Vdc"
                  ></vyw-select-input>
                </div>
                <div>
          ...
          <v-card class="mt-1">
            ...
            <v-card-text>
              <div class="d-flex justify-center">
                <div class="half">
                  <vyw-numeric-input
                    data-key="RectShuntVal"
                    label="Rectifier shunt (@ 100 mV)"
                    suffix="A"
                    :bottom="Number(0.5)"
                    :top="Number(9999)"
                    hint="[0.5~9,999]"
          ...
          <v-card>
            ...
            <v-card-text>
              <div class="d-flex">
                ...
                <div class="oneThird">
                  <vyw-switch
                    data-key="LoadVoltMeter"
                    :labels="['No VLoad meter', 'VLoad meter present']"
                  />
                </div>
                <div class="oneThird">
                  <vyw-switch
                    data-key="AhMeterDisplay"
                    :labels="['No Ah meter', 'Ah meter present']"
                  />
                </div>
              </div>
            </v-card-text>
          ...
          <v-card class="mt-1" :class="{grey: adjustDisabled, 'lighten-3': adjustDisabled}">
            ...
            <v-card-text>
              <div class="d-flex">
                <div>
                  <vyw-switch
                    data-key="ManCurrAdjust"
                    :labels="['Variable current off', 'Variable current on']"
                  />
                </div>
                <div>
                  <vyw-switch
                    data-key="ManVoltAdjust"
                    :labels="['Variable voltage off', 'Variable voltage on']"
                  />
                </div>
              </div>
              <div class="d-flex">
          ...
          <v-card class="mt-1">
            ...
            <v-card-text>
              <div class="d-flex">
                <div class="oneThird">
                  <vyw-switch
                    data-key="RfShtdnEnable"
                    :labels="['Not on rectifier failure', 'On rectifier failure']"
                  />
                </div>
                <div class="oneThird">
                  <vyw-switch
                    data-key="MfShtdnEnable"
                    :labels="['Not on mains failure', 'On mains failure']"
                  />
                </div>
                <div class="oneThird">
                  <vyw-switch
                    data-key="HvShtdnEnable"
                    :labels="['Not on high DC voltage', 'On high DC voltage']"
                  />
                </div>
              </div>
            </v-card-text>
          ...
          <v-card class="mt-1">
            ...
            <v-card-text>
              ...
              <div class="d-flex">
                <div>
                  <vyw-numeric-input
                    data-key="Edit_DC_CURA"
                    label="Current when mains off"
                    suffix="A"
                    :bottom="Number(0)"
                    :top="Number(1000)"
                  />
                ...
                <div>
                  <vyw-numeric-input
                    data-key="Edit_DC_CURP"
                    label="Current when mains on"
                    suffix="A"
                    :bottom="Number(0)"
                    :top="Number(1000)"
                  />
              ...
              <div class="d-flex">
                ...
                <div>
                  <vyw-numeric-input
                    data-key="Edit_DC_DDLPDC"
                    label="Duration of peak current"
                    suffix="s"
                    :bottom="Number(0)"
                  />
                </div>
